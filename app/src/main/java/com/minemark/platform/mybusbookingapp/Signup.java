...
//        }
        ...
        buttonSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference userdata = database.child("userphone");
                                ...
                                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            usersignupdataholder obj = new usersignupdataholder(fullname, phonenumber, email);
                                            ...
                                            userphoneholder obj1 = new userphoneholder(email);
                                            DatabaseReference userdata1 = database.child("userphone");
                                            userdata1.child(phonenumber).setValue(obj1);
